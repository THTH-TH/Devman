...
const BUCKETS = [
  ...
  { key: 'this-month', label: 'This month', headerCls: 'bg-blue-50 text-blue-700 border-blue-200', rowCls: '' },
                    ...
                    <div key={item.id} className={`flex items-center gap-4 px-5 py-3 ${b.rowCls}`}>
                      ...
                      {item.project && (
                        <Link
                          ...
                          className="text-xs text-blue-600 hover:underline shrink-0 hidden sm:block"
