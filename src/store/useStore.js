...
const mapDocumentShare = r => ({
  ...
  subject: r.subject || '',
  message: r.message || '',
  deliveryMethod: r.delivery_method || 'link',
  recipients: Array.isArray(r.recipients) ? r.recipients : [],
  recipientGroups: Array.isArray(r.recipient_groups) ? r.recipient_groups : [],
...
const useStore = create((set, get) => ({
  ...
  async addDocumentShare(data) {
    ...
    const row = {
      ...
      message: data.message || '',
      delivery_method: data.deliveryMethod || 'link',
      recipients: data.recipients || [],
      recipient_groups: data.recipientGroups || [],
